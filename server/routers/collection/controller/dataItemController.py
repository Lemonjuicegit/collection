...
from routers.collection.vo import addDataItemArgs,DataItemArgs
from routers.collection.result import Result
from routers.collection.service import dataItemService
...
@router.post("/update")
def updateItem(args: DataItemArgs):
    dataItemService.update([args.model_dump(exclude_unset=True)])
    return Result()
