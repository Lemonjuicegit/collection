...
from routers import store, unzip, log, use, Api, state
...
home_dir_absolute = f"{cwd_path}\\home"
assets_dir_absolute = f"{cwd_path}\\static\\assets"
assets_manage_absolute = f"{cwd_path}\\manage\\assets"
assets_manage_absolute_test = f"{cwd_path}\\manage_test\\assets"
environment = 2
if environment == 1:
...
async def ip_access_authorization(args_ip:str):
    ip_access = ['localhost', '192.168.2.139','192.168.2.50']
